...
class FeeEstimatorSpec extends AnyFunSuite {
  ...
  test("should update fee when diff ratio exceeded") {
    val feeConf = OnChainFeeConf(FeeTargets(1, 1, 1, spendAnchorWithoutHtlcs = true, 1, 1, 1), new TestFeeEstimator(), closeOnOfflineMismatch = true, updateFeeMinDiffRatio = 0.1, defaultFeerateTolerance, Map.empty)
  ...
  test("get commitment feerate") {
    ...
    val feeConf = OnChainFeeConf(FeeTargets(1, 2, 6, spendAnchorWithoutHtlcs = true, 1, 1, 1), feeEstimator, closeOnOfflineMismatch = true, updateFeeMinDiffRatio = 0.1, defaultFeerateTolerance, Map.empty)
  ...
  test("get commitment feerate (anchor outputs)") {
    ...
    val feeConf = OnChainFeeConf(FeeTargets(1, 2, 6, spendAnchorWithoutHtlcs = true, 1, 1, 1), feeEstimator, closeOnOfflineMismatch = true, updateFeeMinDiffRatio = 0.1, defaultFeerateTolerance, Map(overrideNodeId -> defaultFeerateTolerance.copy(anchorOutputMaxCommitFeerate = overrideMaxCommitFeerate)))
