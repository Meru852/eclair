...
object ChannelRelayerSpec {
  ...
  def createValidIncomingPacket(payload: ChannelRelayData, amountIn: MilliSatoshi = 1_100_000 msat, expiryIn: CltvExpiry = CltvExpiry(400_100)): IncomingPaymentPacket.ChannelRelayPacket = {
